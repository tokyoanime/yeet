...
class ReviewEdit extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.getReview(this.props.match.params.reviewId).then(() => {
  ...
  handleEditReview(e) {
    ...
    this.props
      ...
      .then(() =>
        this.props.history.push(`/biz/${this.props.review.business_id}`)
      );
  }
  ...
  render() {
    ...
    const errors = this.props.reviewErr.map((err) => {
      return <div className='review-error'>{err}</div>;
    });
    ...
    const requireLogin = <div>Log in to update review.</div>;
        ...
        <div className='review-edit-form'>
          ...
          <form onSubmit={this.handleEditReview}>
            ...
            <textarea
              ...
              onChange={this.updateField('review_body')}
