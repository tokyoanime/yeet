    ...
    const bizUrl =
      biz.biz_url !== '' ? (
        <div className='biz-url-container'>
          ...
          <div>
            <a href={`http://www.${biz.biz_url}`} target='_blank'>
              {biz.biz_url}
            </a>
          </div>
        </div>
    ...
    return (
      <div>
        ...
        <div className='biz-carousel-container'>
          <i id='prevBtn' className='material-icons' onClick={this.handlePrev}>
            keyboard_arrow_left
          </i>
          <i id='nextBtn' className='material-icons' onClick={this.handleNext}>
            keyboard_arrow_right
          </i>
          <div className='biz-carousel-slide'>{bizPics}</div>
        </div>
        ...
        <div className='biz-info-container'>
                  ...
                  <div style={{ height: '100%', width: '100%' }}>
                    ...
                    >
                      <GoogleMapMarker
                        ...
                        lng={biz.biz_lng}
                        text={
                          <i className='material-icons' id='googleMapMarker'>
                            star
                          </i>
                        }
                      />
          ...
          <div className='biz-sub-right'>
            <div className='biz-static-info-container'>
              ...
              <div
                className='biz-known-for-container'
                id='biz-known-for-container'
              >
                <div>
                  <div>
